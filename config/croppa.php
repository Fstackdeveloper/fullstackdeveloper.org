...
return array(
	...
	*/
	 ...
	 * src_dir. The path component of the regpublicex must exist in the first captured
	 ...
	 */
	 //'url_prefix' => 'https://'.Illuminate\Http\Request::getHttpHost().'/storage/thumbnails/',         // Local
		'url_prefix' => config('APP_URL').'/storage/thumbnails/',         // Local
