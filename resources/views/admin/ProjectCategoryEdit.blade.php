                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet light form-fit bordered">
                                    ...
                                    <div class="portlet-body form">
                                        <!-- BEGIN FORM-->
                                        <form action="{{ route('project.category.update', array('id'=>$projectCategory->id)) }}" class="form-horizontal form-bordered"    method="post" enctype="multipart/form-data" >
                                            <div class="form-body">
                                           ...
                                           <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input name="projectCategory[title]" id="title" type="text" class="form-control input-circle" placeholder="Category Title" value="{{ $projectCategory->title }} "  required autofocus> </div>
                                            </div>
