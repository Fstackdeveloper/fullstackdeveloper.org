...
@section('title', 'Edit Project Client')
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet light form-fit bordered">
                                    ...
                                    <div class="portlet-body form">
                                        <!-- BEGIN FORM-->
                                        <form action="{{ route('project.client.update', array('id'=>$projectClient->id)) }}" class="form-horizontal form-bordered"    method="post" enctype="multipart/form-data" >
                                            <div class="form-body">
                                           ...
                                           <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input name="projectClient[name]" id="name" type="text" class="form-control input-circle" placeholder="client Title" value="{{ $projectClient->name }} "  required autofocus> </div>
                                            </div>
