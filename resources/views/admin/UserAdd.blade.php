                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet light form-fit bordered">
                                    ...
                                    <div class="portlet-body form">
                                        <!-- BEGIN FORM-->
                                        <form action="{{ route('user.store') }}" class="form-horizontal form-bordered"    method="post" enctype="multipart/form-data" >
                                            <div class="form-body">
                                           ...
                                           <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input name="user[name]" id="name" type="text" class="form-control input-circle" placeholder="Name"  value="{{ old('user.name') }}" required autofocus> 
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                  <input name="user[email]" id="email" type="email" class="form-control input-circle" placeholder="info@example.com"  value="{{ old('user.email') }}" required>
