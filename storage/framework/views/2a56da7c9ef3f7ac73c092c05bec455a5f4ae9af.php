                                    ...
                                    <div class="portlet-body form">
                                        ...
                                        <form action="<?php echo e(route('project.category.store')); ?>" class="form-horizontal form-bordered"    method="post" enctype="multipart/form-data" >
                                           ...
                                           <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input name="projectCategory[title]" id="title" type="text" class="form-control input-circle" placeholder="Category Title" value="<?php echo e($projectCategory->title); ?> "  required autofocus> </div>
                                            </div>
