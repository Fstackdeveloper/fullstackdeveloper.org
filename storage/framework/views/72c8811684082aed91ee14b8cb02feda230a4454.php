                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet light form-fit bordered">
                                    ...
                                    <div class="portlet-body form">
                                        <!-- BEGIN FORM-->
                                        <form action="<?php echo e(route('user.store')); ?>" class="form-horizontal form-bordered"    method="post" enctype="multipart/form-data" >
                                            <div class="form-body">
                                           ...
                                           <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input name="user[name]" id="name" type="text" class="form-control input-circle" placeholder="Name"  value="<?php echo e(old('user.name')); ?>" required autofocus> 
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                  <input name="user[email]" id="email" type="email" class="form-control input-circle" placeholder="info@example.com"  value="<?php echo e(old('user.email')); ?>" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input name="user[password]" id="password" type="password" class="form-control input-circle"  required> 
                                           ...
                                           <div class="form-group">
                                                <label class="control-label col-md-3">Password</label>
                                                <div class="col-md-9">
                                                    <input name="user[password_confirmation]" id="password_confirmation" type="password" class="form-control input-circle"  required> 
