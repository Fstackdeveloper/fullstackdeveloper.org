...
var ComponentsBootstrapSelect = function () {
    ...
    return {
        ...
        init: function () {      
			...
			$('.category-select').selectpicker('val', '<?php echo e($project->project_categories_id); ?>')
			$('.client-select').selectpicker('val', '<?php echo e($project->project_clients_id); ?>')
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet light form-fit bordered">
                                    ...
                                    <div class="portlet-body form">
                                        <!-- BEGIN FORM-->
                                        <form action="<?php echo e(route('project.update', array('id'=>$project->id))); ?>" class="form-horizontal form-bordered"    method="post" enctype="multipart/form-data" >
                                            <div class="form-body">
                                           ...
                                           <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input name="project[title]" id="title" type="text" class="form-control input-circle" placeholder="<?php echo e($project->title); ?>" value="<?php echo e($project->title); ?>" required> </div>
                                            </div>

                                             <div class="form-group">
                                                <label class="control-label col-md-3">Description</label>
                                                <div class="col-md-9">
                                                <textarea name="project[description]" id="description" class="tinymce"><?php echo e($project->description); ?></textarea> </div>
                                             </div>
                                           ...
                                           <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                                    
                                                  ...
                                                  <input name="project[release_date]" id="release_date"  class="form-control" data-provide="datepicker" data-date-format="yyyy-mm-dd" value="<?php echo e($project->release_date); ?>"  required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input name="project[url]" id="url" type="text" class="form-control input-circle" placeholder="<?php echo e($project->url); ?>" value="<?php echo e($project->url); ?> " required> </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                          ...
                                                          <select name="project[project_clients_id]" id="project_clients_id"  class="client-select form-control"  value="<?php echo e($project->project_clients_id); ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                          ...
                                                          <select name="project[project_categories_id]" id="project_categories_id"  class="category-select form-control"  value="<?php echo e($project->project_categories_id); ?>">
